...
// Linkedin
tarteaucitron.services.linkediniframe = {
    "key": "linkediniframe",
    "type": "social",
    "name": "Linkedin (cards)",
    "uri": "https://www.linkedin.com/legal/cookie_policy",
    ...
    "js": function () {
        "use strict";
        tarteaucitron.fallback(['linkedin_iframe'], function (x) {
            var id = x.getAttribute("id"),
                width = x.getAttribute("width"),
                height = x.getAttribute("height");
            var widgetURL = "https://www.linkedin.com/embed/feed/update/" + id;
            return "<iframe width=\"" + width + "\" height=\"" + height + "\" src=\"" + widgetURL + "\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\"></iframe>";
        });
    },
    "fallback": function () {
        "use strict";
        var id = 'linkediniframe';
        tarteaucitron.fallback(['linkedin_iframe'], function (elem) {
            elem.style.width = tarteaucitron.getElemAttr(elem,'width') + 'px';
            elem.style.height = tarteaucitron.getElemAttr(elem,'height') + 'px';
            return tarteaucitron.engage(id)
        });
